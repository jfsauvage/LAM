...
FUNCTION dsp2psf, dspall, maskpupil, sim_params, $
...
longexposure = fltarr(sim_params.dim, sim_params.dim, nb_dirperf)

FOR ind_dirperf = 0, nb_dirperf-1 DO BEGIN
    dsp = dspall[*, *, ind_dirperf]
    ...
    ; extraction of pupil
    pup = crop(maskpupil, /m, nc = sim_params.dimpup, /silent)
    ...
    longexposure[*,*, ind_dirperf]= sysPSF/total(sysPSF) 
ENDFOR
